...
public class Graph {
    ...
    private boolean isEdgesIntersection(Edge edge1, Edge edge2) {
        ...
        if (denominator == 0) {
            ...
            long numerator_a = (x4 - x2) * (y4 - y3) - (x4 - x3) * (y4 - y2);
            long numerator_b = (x1 - x2) * (y4 - y2) - (x4 - x2) * (y1 - y2);
            long Ua = numerator_a / denominator;
            long Ub = numerator_b / denominator;
